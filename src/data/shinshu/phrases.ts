...
export const PHRASES: Phrase[] = [
  ...
  {
    id: 'shoshinge-ryuuju',
    text: '顕示難行陸路苦　信楽易行水道楽',
    reading: 'けんじなんぎょうろじく　しんぎょういぎょうすいどうらく',
    source: '『正信偈』龍樹章（『教行信証』行巻・依釈段）',
    gloss:
      '読み下せば「難行の陸路、苦しきことを顕示し、易行の水道、楽しきことを信楽せしむ」。重い荷を背負って自分の足で陸を行くのと、荷ごと船に乗せてもらって水を行くのと、道が二本ある。',
    use: 'お勤めで称えたばかりのこの一行を、ほどくところから。「修行しないと駄目なのでは」と言われたときにも。二句で切らず、次の「憶念弥陀仏本願　自然即時入必定」——乗せられたその時に行き先が定まる——まで続けて読む。楽ができる話にしない。歩いて行く道を、遠回りだとも間違いだとも言わない。',
    emotions: ['tsukare', 'mayoi', 'jikokeno'],
    topics: ['tayoru', 'wakaranai'],
    caution:
      '「楽である」ことが結びではない。直後の二句「憶念弥陀仏本願　自然即時入必定」までで一つ。訓点（「陸路、苦しきこと」か「陸路の苦しきこと」か、「即の時必定に入る」か「即の時に」か）は聖典で確かめる。',
  },
  {
    id: 'shoshinge-doushaku',
    text: '道綽決聖道難証　唯明浄土可通入',
    reading: 'どうしゃくけっしょうどうなんしょう　ゆいみょうじょうどかつにゅう',
    source: '『正信偈』道綽章（『教行信証』行巻・依釈段）',
    gloss:
      '読み下せば「道綽、聖道の証しがたきことを決して、ただ浄土の通入すべきことを明かす」。ここの「決して」は決判して、見きわめて、の意。自分の力でさとるのは、この身には無理だ——そう見きわめて、だれでも通れるほうの道へ移った。',
    use: '無理だと見きわめたところから始まる、という話に。まず認めた人がいる。いま別の道を歩いておられる方を下に置く言い方にしない。',
    emotions: ['mayoi', 'henka', 'munashisa'],
    topics: ['wakaranai', 'hajimari'],
    caution:
      '章そのものは、次の聯で「万善自力貶勤修」——自力の勤修を貶す、と言い切っている。そこを薄めない。そのうえで、その語をそのまま人の上下に移さない。道綽が学問から移った人だという経歴は、この句にも正信偈にもなく、『続高僧伝』の道綽伝など別の伝による。混ぜて語らない。「決して」が決判の意であることを、聖典の返点・左訓で確かめる。',
  },
  {
    id: 'shoshinge-shouge',
  ...
  {
    id: 'shoshinge-genku',
    text: '本師源空明仏教　憐愍善悪凡夫人',
    reading: 'ほんじげんくうみょうぶっきょう　れんみんぜんまくぼんぶにん',
    source: '『正信偈』源空章（『教行信証』行巻・依釈段）',
    gloss:
      '読み下せば「本師源空は仏教に明らかにして、善悪の凡夫人を憐愍せしむ」。親鸞聖人の先生、法然（源空）。善い人・悪い人と分けずに、どちらもそのまま、ほうっておけない人として見た。',
    use: '教えてもらった人の話に。善い悪いで選り分けず、まとめて凡夫と呼んだ、その一点で。聞いておられる方を善い人・悪い人に当てはめない。',
    emotions: ['kansha', 'jikokeno', 'ningenkankei'],
    topics: ['hito', 'naoranai'],
    caution:
      '憐れむのは源空（法然）で、如来ではない。語尾が「憐愍せしむ」か「憐愍したまう」かは聖典の訓点で確かめる。「愍」であって「憫」ではない。',
  },
  {
    id: 'wasan-hongan',
